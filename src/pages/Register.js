...
const Register = () => {
  return (
    <div className="relative bg-white w-full h-[2395px] overflow-hidden text-left text-base text-gray-1400 font-roboto">
      <BG2 />
      <LoginAccount />
      <Banner1 />
      <div className="absolute top-[1516px] left-[0px] w-[1920px] h-[877px] overflow-hidden">
